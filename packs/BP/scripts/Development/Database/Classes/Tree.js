...
/** @param {string} path @param {World | Player | Entity | ItemStack} context @returns {Branch}  */
export function PathToTree(path, context) {
    ...
    /** @param {string[]} ids_arr @param {number} current @param {Branch | Leaf} input  */
